...
async def manage_cat(callback: CallbackQuery, session: AsyncIOMotorDatabase):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton(text="🔑 Edit Instructions", callback_data=f"admin_edit_instr_{cat_id}"), InlineKeyboardButton(text="🖼️ Edit QR Code", callback_data=f"admin_edit_qr_{cat_id}")],
